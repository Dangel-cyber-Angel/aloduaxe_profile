...
document.write('            <p style="font-size:20px; ">ditmemay</p><br>');
document.write('            <p style="font-size:20px; ">🔥 Được Tạo Bởi<a href="https://t.me/Adam022022" target="_blank"  style=" color:blue; font-weight: bold;"> Vương Thanh Nhã</p>');
document.write('            </div>');
document.write('    </div>');
document.write('    ');
